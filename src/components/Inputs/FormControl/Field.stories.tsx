...
import { Label, Input, TextArea, HTMLSelect as Select } from "../..";
import { FormControl } from ".";

export default {
  title: "Components/Inputs/FormControl/Field",
    ...
    docs: {
      page: () => (
        <>
          <Title />
          <Description>
            Form field component, an extension of the `Grid` component, that
            groups a label, an input, help and error messaged.
          </Description>
...
export const WithSelect = () => (
  <FormControl.Field>
    <Label>Legend</Label>
    <Select defaultValue="Lorem ipsum dolor sit amet">
