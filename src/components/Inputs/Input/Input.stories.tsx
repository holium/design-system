...
export const Default = () => (
  <Box>
    ...
    <Input
      placeholder="Placeholder Text"
      rightIcon={<Icons.Close color="text.secondary" aria-hidden />}
      mb={4}
    />
    <Input
      placeholder="Placeholder Text"
...
export const Error = () => (
  <Box>
    ...
    <Input
      ...
      value=""
      placeholder="Placeholder Text"
      rightIcon={<Icons.Close color="ui.intent.alert" aria-hidden />}
      mb={4}
    />
    <Input
      error
...
export const InlineValidation = () => (
  <Box>
    <Input
      ...
      rightIcon={<Icons.CheckCircle aria-hidden color="ui.intent.success" />}
      mb={3}
    />
    <Input
      placeholder="Email address"
      error
      rightIcon={<Icons.Error aria-hidden color="ui.intent.alert" />}
    />
  </Box>
);
